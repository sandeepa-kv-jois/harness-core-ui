...
import * as hooks from '@common/hooks/useQueryParamsState'
...
describe('DashboardView', () => {
  ...
  const useQueryParamsStateMock = jest.spyOn(hooks, 'useQueryParamsState')
  ...
  beforeEach(() => {
    ...
    useQueryParamsStateMock.mockReturnValue([undefined, jest.fn()])
