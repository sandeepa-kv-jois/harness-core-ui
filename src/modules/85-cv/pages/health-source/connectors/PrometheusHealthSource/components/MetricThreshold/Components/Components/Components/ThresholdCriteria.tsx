...
import { MetricCriteriaValues } from '@cv/pages/health-source/common/MetricThresholds/MetricThresholds.constants'
...
import type { ThresholdCriteriaPropsType } from '../../../PrometheusMetricThreshold.types'
import { getCriterialItems, getCriteriaPercentageDropdownOptions } from './AppDThresholdSelectUtils'
import { PercentageCriteriaDropdownValues as PercentageType } from '../../../PrometheusMetricThresholdConstants'
