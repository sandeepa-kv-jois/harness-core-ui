...
import { ECSInfraSpecInputForm, ECSInfraSpecInputFormProps } from './ECSInfraSpecInputForm'
...
export class ECSInfraSpec extends PipelineStep<EcsInfrastructureStep> {
  ...
  renderStep(props: StepProps<EcsInfrastructure>): JSX.Element {
    ...
    if (stepViewType === StepViewType.InputSet || stepViewType === StepViewType.DeploymentForm) {
      ...
      return (
        <VariablesListTable
          data={(customStepProps as ECSInfraSpecEditableProps)?.variablesData?.infrastructureDefinition?.spec}
          originalData={initialValues.infrastructureDefinition?.spec || initialValues}
          metadataMap={(customStepProps as ECSInfraSpecEditableProps).metadataMap}
        />
      )
    }
    return (
