...
export const ccmMetadataResponse = metadataRes

export const testConnectionResponse = {
  status: 'ERROR',
  code: 'GENERAL_ERROR',
  message: 'Unexpected error occurred while submitting task.',
  ...
  responseMessages: [
    ...
    },
    {
      ...
      level: 'ERROR',
      message:
        'INTERNAL: io.harness.exception.HttpResponseException: Unsuccessful HTTP call: status code = 503, message = <html>\r\n<head><title>503 Service Temporarily Unavailable</title></head>\r\n<body>\r\n<center><h1>503 Service Temporarily Unavailable</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n',
      exception: null,
      failureTypes: []
    }
  ],
...
export const permissionsYamlMock = `
---
